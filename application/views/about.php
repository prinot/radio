...
<section class="custom-banner">
        ...
        <section class="radio-jockey-area section-padding-2 gray-bg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-delay="0.4s">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="single-radio-jockey">
