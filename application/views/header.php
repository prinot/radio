...
<!--                             <li class="nav-item dropdown">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="engineers.html" id="navbarDropdownMenuLink4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Usuarios</a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink4">
                                  <a class="dropdown-item" href="<?=base_url('registro')?>">Registrate</a>
                                  <a class="dropdown-item" href="<?=base_url('login')?>">Acceder</a>
